...
import random
import timm
from AltitudeDataset import AltitudeDataset
import wandb
...
history = [] 
  # DATASET
#v2.Grayscale(3)
train_dataset = AltitudeDataset(annotations_file=  '/home/o7ahmed/scratch/AltitudeDataset/Labels.csv',
                                    img_dir= '/home/o7ahmed/scratch/AltitudeDataset/train/frame',
                                     transform=transforms.Compose([
                                               
                                               v2.Resize((224,224)),
                                               v2.PILToTensor()])
                                          )
val_dataset = AltitudeDataset(annotations_file=  '/home/o7ahmed/scratch/AltitudeDataset/valLabels.csv',
                                    img_dir= '/home/o7ahmed/scratch/AltitudeDataset/validation/frame',
                                           transform=transforms.Compose([
...
for x in models:
    ...
    torch.save(model.state_dict(), '/home/o7ahmed/scratch/AltitudeModels/'+x+'AltitudeBestModel.pth')
    run.finish()
