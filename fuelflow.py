...
import random
import timm
from FuelFlowDataset import FuelFlowDataset
import wandb
...
history = [] 
  # DATASET
#v2.Grayscale(3)
train_dataset = FuelFlowDataset(annotations_file=  '/home/o7ahmed/scratch/FuelFlowDataset/Labels.csv',
                                    img_dir= '/home/o7ahmed/scratch/FuelFlowDataset/train/frame',
                                     transform=transforms.Compose([
                                               
                                               v2.Resize((224,224)),
                                               v2.PILToTensor()])
                                          )
val_dataset = FuelFlowDataset(annotations_file=  '/home/o7ahmed/scratch/FuelFlowDataset/valLabels.csv',
                                    img_dir= '/home/o7ahmed/scratch/FuelFlowDataset/validation/frame',
                                           transform=transforms.Compose([
...
for x in models:
    ...
    torch.save(model.state_dict(), '/home/o7ahmed/scratch/FuelFlowModels/'+x+'FuelFlowBestModel.pth')
    run.finish()
