...
history = [] 
  # DATASET
#v2.Grayscale(3)
train_dataset = RollDataset(annotations_file=  '/home/o7ahmed/scratch/RollDataset/Labels.csv',
                                    img_dir= '/home/o7ahmed/scratch/RollDataset/train/frame',
                                     transform=transforms.Compose([
                                               
                                               v2.Resize((224,224)),
                                               v2.PILToTensor()])
                                          )
val_dataset = RollDataset(annotations_file=  '/home/o7ahmed/scratch/RollDataset/valLabels.csv',
                                    img_dir= '/home/o7ahmed/scratch/RollDataset/validation/frame',
                                           transform=transforms.Compose([
...
for x in models:
    ...
    config={
        ...
        "learning_rate": lr,
        "architecture": x,
        "dataset": "RollDataset - Without pitch ",
        "epochs": epochs,
    },
    )
    ...
    torch.save(model.state_dict(), '/home/o7ahmed/scratch/RollOnlyModels/'+x+'RollOnlyBestModel.pth')
    run.finish()
