...
import random
import timm
from HeadingDataset import HeadingDataset
import wandb
...
history = [] 
  # DATASET
#v2.Grayscale(3)
train_dataset = HeadingDataset(annotations_file=  '/home/o7ahmed/scratch/HeadingDataset/Labels.csv',
                                    img_dir= '/home/o7ahmed/scratch/HeadingDataset/train/frame',
                                     transform=transforms.Compose([
                                               
                                               v2.Resize((224,224)),
                                               v2.PILToTensor()])
                                          )
val_dataset = HeadingDataset(annotations_file=  '/home/o7ahmed/scratch/HeadingDataset/valLabels.csv',
                                    img_dir= '/home/o7ahmed/scratch/HeadingDataset/validation/frame',
                                           transform=transforms.Compose([
...
for x in models:
    ...
    torch.save(model.state_dict(), '/home/o7ahmed/scratch/HeadingModels/'+x+'HeadingBestModel.pth')
    run.finish()
