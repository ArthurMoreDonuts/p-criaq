...
history = [] 
  # DATASET
#v2.Grayscale(3)
train_dataset = PitchDataset(annotations_file=  '/home/o7ahmed/scratch/Roll&PitchDataset/Labels.csv',
...
val_dataset = PitchDataset(annotations_file=  '/home/o7ahmed/scratch/Roll&PitchDataset/valLabels.csv',
...
for x in models:
    ...
    torch.save(model.state_dict(), '/home/o7ahmed/scratch/PitchModels/'+x+'PitchBestModel.pth')
    run.finish()
