...
import random
import timm
from RPMDataset import RPMDataset
import wandb
...
history = [] 
  # DATASET
#v2.Grayscale(3)
train_dataset = RPMDataset(annotations_file=  '/home/o7ahmed/scratch/RPMDataset/Labels.csv',
                                    img_dir= '/home/o7ahmed/scratch/RPMDataset/train/frame',
                                     transform=transforms.Compose([
                                               
                                               v2.Resize((224,224)),
                                               v2.PILToTensor()])
                                          )
val_dataset = RPMDataset(annotations_file=  '/home/o7ahmed/scratch/RPMDataset/valLabels.csv',
                                    img_dir= '/home/o7ahmed/scratch/RPMDataset/validation/frame',
                                           transform=transforms.Compose([
...
for x in models:
    ...
    torch.save(model.state_dict(), '/home/o7ahmed/scratch/RPMModels/'+x+'RPMBestModel.pth')
    run.finish()
